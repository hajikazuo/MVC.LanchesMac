...
namespace LanchesMac.Services
{
    public class SeedInitialService : ISeedInitial
    {
        ...
        public void Seed()
        {
            ...
            CreateLanche(1, "Pão, hambúrger, ovo, presunto, queijo e batata palha", "Delicioso pão de hambúrger com ovo frito; presunto e queijo de primeira qualidade acompanhado com batata palha", true, "1.png", "1.png", false, "Cheese Salada", 12.50m).GetAwaiter().GetResult();
            CreateLanche(1, "Pão, presunto, mussarela e tomate", "Delicioso pão francês quentinho na chapa com presunto e mussarela bem servidos com tomate preparado com carinho.", true, "2.png", "2.png", false, "Misto Quente", 8.00m).GetAwaiter().GetResult();
            CreateLanche(1, "Pão, hambúrger, presunto, mussarela e batalha palha", "Pão de hambúrger especial com hambúrger de nossa preparação e presunto e mussarela; acompanha batata palha.", true, "3.png", "3.png", false, "Cheese Burger", 11.00m).GetAwaiter().GetResult();
            CreateLanche(2, "Pão Integral, queijo branco, peito de peru, cenoura, alface, iogurte", "Pão integral natural com queijo branco, peito de peru e cenoura ralada com alface picado e iorgurte natural.", true, "4.png", "4.png", true, "Lanche Natural Peito Peru", 15.00m).GetAwaiter().GetResult();
        }
